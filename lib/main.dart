...
import 'package:wake_word_proj/predictor.dart';
...
class _AudioRecorderState extends State<AudioRecorder> {
  ...
  Future<void> _stop() async {
    ...
    if (path != null) {
      ...
      // Predictor().predict(byteData);
      // print(AudioPredictor().predictClip(path, byteData));
      print(TflitePredictor().predict(byteData));
    }
  }
